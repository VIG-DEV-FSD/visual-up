$(function () {
  ...
  $('.portfolio__slider').slick({
    ...
    infinite: true,
    nextArrow:
      '<button class="slick-next portfolio-next"><img src="img/arrow-right.png"></button>',
    prevArrow:
      '<button class="slick-prev portfolio-prev"><img src="img/arrow-left.png"></button>',
    responsive: [
      {
        breakpoint: 768,
        settings: {
  ...
  $('.header__menu-btn').on('click', function () {
    ...
    $('.header__menu-body').html(
      menu + '<div class="header__com">' + com + '</div>'
    )
  ...
  function checkWidth() {
    if (
      document.documentElement.clientWidth < 1031 &&
      !$('.services__inner').hasClass('slick-slider')
    ) {
    ...
    if (
      document.documentElement.clientWidth < 971 &&
      !$('.reviews__inner').hasClass('slick-slider')
    ) {
  ...
  function checkFile(target) {
    ...
    let form = target.closest('form')
    let field = target
      .closest('.discus__form-file')
      .querySelector('.discus-file__content')

    if (num > 5) {
      field.innerHTML =
        document.documentElement.clientWidth > 880
          ? 'Можно выбрать максимум 5 файлов'
          : '!'
      ...
      field.innerHTML =
        document.documentElement.clientWidth > 880 ? 'Выбран 1 файл' : '1'
      field.classList.remove('error')
      field.style.display = 'flex'
      form.fileValid = true
    } else if (num == 5) {
      field.innerHTML =
        document.documentElement.clientWidth > 880 ? 'Выбрано 5 файлов' : '5'
      field.classList.remove('error')
      field.style.display = 'flex'
      form.fileValid = true
    } else {
  ...
  function openModal(modal, content, isThanks) {
    ...
    if (isThanks)
      modal.querySelector('.modal__body').classList.add('modal__body-thanks')
  ...
  function loadReviews() {
    ...
    const text = 'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Deserunt necessitatibus ducimus pariatur sapiente? Incidunt harum iusto dicta facere unde recusandae. Corporis praesentium numquam repellat quaerat nulla magnam labore ea officiis.'

    let more =
      `<div class="reviews__item reviews__item-more"><div class="reviews__item-bg"></div> <div class="reviews__item-inner"> <div class="reviews__item-head"><div class="reviews__item-img"><img src="img/review-1.png" alt=""></div><div class="reviews__item-content"><div class="reviews__item-author"> Иванов Иван</div><div class="reviews__item-service">Landing page, адаптив</div></div><a href="https://www.instagram.com/visual.up/" class="reviews__item-link"><img src="img/arrow-review.png" alt=""></a> </div><div class="reviews__item-body">${text}</div></div></div><div class="reviews__item reviews__item-more"><div class="reviews__item-bg"></div> <div class="reviews__item-inner"> <div class="reviews__item-head"><div class="reviews__item-img"><img src="img/review-1.png" alt=""></div><div class="reviews__item-content"><div class="reviews__item-author"> Иванов Иван</div><div class="reviews__item-service">Landing page, адаптив</div></div><a href="https://www.instagram.com/visual.up/" class="reviews__item-link"><img src="img/arrow-review.png" alt=""></a> </div><div class="reviews__item-body">${text}</div></div></div><div class="reviews__item reviews__item-more"><div class="reviews__item-bg"></div> <div class="reviews__item-inner"> <div class="reviews__item-head"><div class="reviews__item-img"><img src="img/review-1.png" alt=""></div><div class="reviews__item-content"><div class="reviews__item-author"> Иванов Иван</div><div class="reviews__item-service">Landing page, адаптив</div></div><a href="https://www.instagram.com/visual.up/" class="reviews__item-link"><img src="img/arrow-review.png" alt=""></a> </div><div class="reviews__item-body">${text}</div></div></div><div class="reviews__item reviews__item-more"><div class="reviews__item-bg"></div> <div class="reviews__item-inner"> <div class="reviews__item-head"><div class="reviews__item-img"><img src="img/review-1.png" alt=""></div><div class="reviews__item-content"><div class="reviews__item-author"> Иванов Иван</div><div class="reviews__item-service">Landing page, адаптив</div></div><a href="https://www.instagram.com/visual.up/" class="reviews__item-link"><img src="img/arrow-review.png" alt=""></a> </div><div class="reviews__item-body">${text}</div></div></div><div class="reviews__item reviews__item-more"><div class="reviews__item-bg"></div> <div class="reviews__item-inner"> <div class="reviews__item-head"><div class="reviews__item-img"><img src="img/review-1.png" alt=""></div><div class="reviews__item-content"><div class="reviews__item-author"> Иванов Иван</div><div class="reviews__item-service">Landing page, адаптив</div></div><a href="#" class="reviews__item-link"><img src="img/arrow-review.png" alt=""></a> </div><div class="reviews__item-body">${text}</div></div></div>`
